...
SECTIONS = {
    ...
    "contracts": {"cap_strike_per_mwh", "swap_tenor_years",
                  "anchor_half_life_years", "crossing_steps", "crossing_spread"},
    "scheme": {
        "technologies", "ceiling_per_mw_year", "budget_per_year", "tenor_years",
    },
    "esem": {
        "contract_tenor_years", "contract_start_year_of_plant", "contracted_wacc",
        "screen_multiple_of_spot",
...
class TechCost:
    ...
    def fixed_cost_per_mw_year(self) -> float:
        ...
        enters the comparison. Stating both per MW-year is what allows this: a
...
class Settings:
    ...
    def hourly_price_threshold(self) -> float:
        ...
        five minutes, so one hourly interval here stands for 12 of the market's.
        """
