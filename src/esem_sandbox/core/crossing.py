"""Negotiated clearing: what happens when the two sides do not agree on a price.

By default the contract market clears at a reference price. Both sides accept it, the
volume is whatever the retailer wanted, and the price is what the block has lately
been worth.
