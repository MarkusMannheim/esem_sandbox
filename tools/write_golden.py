...
SEED = 20260904
# Ten, not six. The fingerprint has to cover the mechanism, and the two legs first
# diverge at tick seven: a scheme awards in year one and the plant arrives after its
# lead time, so a six-year run pins two legs that are identical to the last decimal.
# test_the_two_legs_are_still_different exists to catch exactly that, and it did.
TICKS = 10
